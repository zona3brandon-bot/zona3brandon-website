...
function calculateTotal(){
  ...
  const total=subtotal+system+box+customs;
  ...
  document.getElementById("customs-fee").textContent=money(customs);
...
document.getElementById("customs").addEventListener("input",calculateTotal);
